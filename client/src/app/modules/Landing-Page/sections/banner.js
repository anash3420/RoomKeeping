...
const Banner = () => {
  return (
    <Box as="section" id="home" sx={styles.section} style={{backgroundColor: "#fff"}}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Relax while the Room Keeper cleans the room for you"
            description="A Room Keeping app for students, by the students!"
          />
          <Box as="figure" sx={styles.illustration}>
            <Box sx={styles.buttonWrapper}>
            <Link to="/auth/register"><Button style = {{fontSize: "18px"}}>Get Started</Button></Link>
            </Box>
